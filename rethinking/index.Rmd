...
The valuable U has indeed helped witht he accuracy. This is, however, expected, since we're giving more relevant information to the model. The next example should be a more interesting experiment.
